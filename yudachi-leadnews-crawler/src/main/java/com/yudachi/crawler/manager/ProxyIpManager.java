...
import com.yudachi.crawler.utils.ProxyIpUtils;
...
import com.yudachi.model.crawler.core.proxy.ProxyValidate;
...
public class ProxyIpManager {
    ...
    private void validateProxyIp(ClIpPool clIpPool) {
        ...
        clIpPool.setError(YudachiStringUtils.getFixedLengthStr(proxyValidate.getError(), 70));
    }
